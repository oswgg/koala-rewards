...
import { useMembershipByClientId } from '@/modules/activities/hooks/useMembershipByClientId';
import { usePrograms } from '@/modules/programs/hooks/usePrograms';
import { businessProfilesLookupService } from '@/modules/business/scan/services/profiles/implementation.profiles-lookup-service';
import type { ProfileByContact } from '@/modules/business/scan/services/profiles/interface.profiles-lookup-service';
...
export function ActivityByPhoneFlow({ onBack, onCancel }: ActivityByPhoneFlowProps) {
    ...
    } = useMembershipByClientId(selectedProgramPublicId ?? undefined, foundProfile?.profileId);

    const findMutation = useMutation({
        mutationFn: () => businessProfilesLookupService.findProfileByContact(phoneInput),
    });
