import { LocalMembership } from '@koalacards/loyalty';
import { LocalMembershipDataSource } from '@koalacards/loyalty/data';
...
class MembershipDexie extends Dexie {
    ...
    constructor() {
        ...
        this.version(DB_VERSION).stores({
            memberships: 'id, program_id, user_id, profile_id, syncStatus, [user_id+program_id]',
        });
    }
}
