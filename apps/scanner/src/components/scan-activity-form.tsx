...
import { FieldDescription, FieldGroup, FieldLabel, Button, Input } from '@koalacards/shared/ui';
import {
...
import { MembershipCardPreview } from '@koalacards/loyalty/ui/components';
import { scannerPortalRoutes } from '@koalacards/loyalty/ui/routes';
import {
    useEarnLimitToday,
    useMembershipByClientId,
} from '@koalacards/loyalty/hooks/memberships/index';
import {
    useRegisterActivity,
    useRedeemReward,
} from '@koalacards/loyalty/hooks/membership-activities/index';
import { useStaff } from '@koalacards/shared/hooks/useStaff';
...
export function ScanActivityForm({
    ...
    const {
        ...
        isLoading,
        isError,
    } = useMembershipByClientId({ membershipRepository, programPublicId, profileId });
    ...
    const { data: staff, isLoading: staffLoading } = useStaff({ authRepository });
    const registerMutation = useRegisterActivity({ membershipActivitiesRepository });
    const redeemMutation = useRedeemReward({ membershipActivitiesRepository });
